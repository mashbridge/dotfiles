...
export PATH=$HOME/bin:/opt/homebrew/bin/:$FLUTTER_HOME/bin:$ANDROID_SDK/build-tools/36.0.0:$ANDROID_HOME:/opt/homebrew/lib/ruby/gems/3.4.0/bin:/opt/homebrew/opt/ruby/bin:$PATH
